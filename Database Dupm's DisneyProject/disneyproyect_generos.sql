...
CREATE TABLE `generos` (
  ...
  PRIMARY KEY (`id`),
  KEY `asociacion-generos_idx` (`Peliculas`),
  CONSTRAINT `asociacion-generos` FOREIGN KEY (`Peliculas`) REFERENCES `asociacion` (`id`)
...
INSERT INTO `generos` VALUES (1,'Accion',NULL,NULL),(2,'Super-Heroes',NULL,NULL),(3,'Comedia',NULL,NULL);
